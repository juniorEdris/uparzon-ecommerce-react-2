          ...
          <div className="">
            {
                      ...
                      <div className="cart_single_body flex-grow-1">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="cart_count_wrapper d-flex align-items-center">
                            <span className={`${item.total_quantity === 1 && 'pointer_disabled'} cart_count dec`} onClick={() => decreamentProduct(item)}>-</span><span>{item?.total_quantity}</span><span className='cart_count inc' onClick={() => increamentProduct(item)}>+</span>
                          </div>
              ...
              </ul> : <div className="d-flex flex-column justify-content-center align-items-center empty_cart_placeholder">
